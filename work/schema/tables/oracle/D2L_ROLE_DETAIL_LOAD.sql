...
CREATE TABLE D2L_ROLE_DETAIL_LOAD (
  ...
  ClassListRoleCategory NVARCHAR2(62) DEFAULT NULL,
  ...
  RoleAlias NVARCHAR2(75) DEFAULT NULL,
  Version NUMBER(20) DEFAULT NULL,
  RoleCode NVARCHAR2(62) DEFAULT NULL
);
