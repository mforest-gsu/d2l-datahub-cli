DROP TABLE D2L_ASSIGNMENT_SUMMARY_LOAD;
CREATE TABLE D2L_ASSIGNMENT_SUMMARY_LOAD (
  DropboxId NUMBER(20) NOT NULL,
  OrgUnitId NUMBER(10) DEFAULT NULL,
  Name NVARCHAR2(160) DEFAULT NULL,
  Category NVARCHAR2(160) DEFAULT NULL,
  Type VARCHAR2(12 CHAR) DEFAULT NULL,
  ...
  SubmissionType VARCHAR2(22 CHAR) DEFAULT NULL,
  CompletionType VARCHAR2(33 CHAR) DEFAULT NULL,
...
CREATE UNIQUE INDEX D2L_ASSIGNMENT_SUMMARY_LOAD_PK ON D2L_ASSIGNMENT_SUMMARY_LOAD (DropboxId);
QUIT;
